...
import test.api.block.ComponentBlock;
...
public class BlockAdapter extends BlockOpen
{
	...
	{
		super(Material.air);//TODO
//		super(real.getMaterial());
		this.real = real;
		this.setLightLevel(real.getMaterial().getLightLevel())
				.setResistance(real.getMaterial().getResistance())
				.setHardness(real.getMaterial().getHardness());
	}

	public int getLightOpacity() {return real.getMaterial().getLightOpacity();}
