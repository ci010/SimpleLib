...
public class BGMPlayer implements IResourceManagerReloadListener
{
	...
	{
		ExternalResource.register(new PackBase(Environment.getDirectory(Environment.mc, "bgm"))
		{
			@Override
...
//		@Override
	...
	{
		this.generateSoundJson(Environment.getDirectory(Environment.mc, "bgm"));
		this.loadLoopTime();
	}

	private void loadLoopTime()
	{
		File sounds = Environment.getDirectory(Environment.mc, "bgm", "sounds");
	...
	{
		File soundsDir = Environment.getDirectory(assetsDir, "sounds");
