...
{
	public static INBTSerializer.Base<BlockPos> posITagSerializer = new INBTSerializer.Base<BlockPos>()
	{
		@Override
	...
	public <T> NBTSerial with(INBTSerializer<T> serializer, Class<T> clz)
	{
