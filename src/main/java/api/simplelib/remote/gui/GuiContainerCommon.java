...
import api.simplelib.remote.capabilities.ComponentProvider;
import api.simplelib.remote.gui.components.GuiComponent;
import api.simplelib.remote.gui.components.GuiTextureBlock;
import api.simplelib.remote.gui.event.ClickEvent;
...
//				comp.setPos(this.guiLeft + comp.getX() - 1, this.guiTop + comp.getY() - 1).initGui();
	...
	{
		return this.isPointInRegion(gui.transform().x, gui.transform().y, gui.transform().width, gui.transform().height, x, y);
	}
