...
public class Pattern3D
{
	...
	public interface Vector3D extends Comparable<Vector3D>
	{
		...
		/**
		 * Get a new vector that has the translate to current vector.
		 *
		 * @param x The translate in x coordination.
		 * @param y The translate in y coordination.
		 * @param z The translate in z coordination.
		 * @return new vector that has a certain translate to current vector.
		 */
