...
public class GuiUtil
{
	...
	private static Gui draw2D = new Gui();

	public static final TextureManager texture = Minecraft.getMinecraft().getTextureManager();
	...
	public static void drawTextureAt(int x, int y, TextureInfo info)
	{
		draw2D.drawTexturedModalRect(x, y, info.getU(), info.getV(), info.getWidth(), info.getHeight());
	}
