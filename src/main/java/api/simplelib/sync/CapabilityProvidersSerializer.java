 ...
 * @author ci010
 */
public class CapabilityProvidersSerializer implements INBTSerializer<ICapabilityProvider>
{
	private static List<INBTSerializer<ICapabilityProvider>> list = Lists.newArrayList();
	...
	public static void register(INBTSerializer<ICapabilityProvider> prov)
	{
		list.add(prov);
	}
	...
	{
		for (INBTSerializer<ICapabilityProvider> serializer : list)
		{
