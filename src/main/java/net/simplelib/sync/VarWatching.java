...
public class VarWatching<T> implements VarSync<T>
{
	...
	public static class VarWatchingEnum<T extends Enum<T>> implements VarSync<T>
	{
		...
		public VarWatchingEnum(Entity entity, T v, String name)
		{
			this.name = name;
			this.tClass = TypeUtils.cast(v.getClass());
	...
	public static class Ranged<T extends Number> extends VarWatching<T>
	{
