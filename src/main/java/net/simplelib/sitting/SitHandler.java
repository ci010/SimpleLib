...
import api.simplelib.sitting.ISeat;
...
public class SitHandler
{
	...
	public static void register(ISeat sitable)
	{
		Block block = sitable.seatBlock();
...
//					ModMessageDispatcher.instance().sendToServer(new PlayerSitMessage(logic.offsetVertical()
//							, event.pos, block));
	}
	...
	private static class SittingMetaInfo
	{
		...
		public SittingMetaInfo(PropertyDirection dir, ISeat.Situation logic)
		{
			this.dir = dir;
			this.logic = logic;
		}
