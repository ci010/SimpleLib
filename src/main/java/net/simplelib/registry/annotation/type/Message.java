 ...
 * <p>The message will be registered as {@link net.simplelib.network.ModNetwork#registerMessage(Class, Class)}</p>
 * <p>About the usage of the message, see
 * {@link net.simplelib.network.ModNetwork#sendTo(IMessage)} and {@link net.simplelib.network.ModNetwork#sendTo(IMessage, EntityPlayerMP)}.</p>
 *
 * @author ci010
 */
