...
import net.simplelib.registry.Namespace;
import net.simplelib.registry.annotation.field.OreDic;
import net.simplelib.registry.annotation.type.BlockItemStruct;
	...
	public ImmutableSet<Namespace> make(Class<?> container)
	{
		...
		for (Field f : container.getFields())
			if (Modifier.isStatic(f.getModifiers()))
			{
				...
				if (f.isAnnotationPresent(BlockItemStruct.class))
