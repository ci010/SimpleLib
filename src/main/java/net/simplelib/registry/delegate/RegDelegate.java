...
import net.simplelib.registry.RegContainer;
import net.simplelib.registry.RegistryHelper;
import net.simplelib.registry.component.ComponentMaker;
import net.simplelib.registry.component.RegComponentBase;
...
public class RegDelegate
{
	...
	protected void register(RegContainer meta)
	{
		...
		{
			DebugLogger.info("Register Component: [{}] <- [{}:{}]",
					namespace.getComponent().getClass().getSimpleName(),
					meta.modid, namespace.getRegisterName());
			namespace.register();
		}
	}
